...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mdpoubli.css') ?>">
...
<body>
    <div class="connexion-card">
        ...
        <p class="piti-txt1">Aucun mail reçu : <a class="click-here" href="<?php echo base_url('Connexion/verifyInfo')?>">Cliquez ici</a></p>
        <div class="duo2">
            <button class="seconnecter">Envoyer mail</button>
            <a href="<?php echo base_url('Connexion') ?>"><button class="seconnecter">Retour à la page de connexion</button></a>
        </div>
    </div>
