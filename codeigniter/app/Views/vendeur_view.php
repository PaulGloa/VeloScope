...
<head>
    ...
    <title>Fiche Vendeur : <?= $vendeur->nom ?></title>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/vendeur.css');?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="<?=base_url('assets/js/test.js')?>" defer></script>
...
<body>
    ...
    <div class="legal-container">
        <h1 class="legal-title"><i class="fa-solid fa-address-card"></i> Identification Vendeur</h1>

        <div class="info-row">
            <span class="info-label">Numéro Vendeur (ID)</span>
            <span class="info-value">#<?= str_pad($vendeur->id, 6, '0', STR_PAD_LEFT) ?></span>
        </div>

        <div class="info-row">
            <span class="info-label">Nom</span>
            <span class="info-value" style="text-transform: uppercase;"><?= $vendeur->nom ?></span>
        </div>

        <div class="info-row">
            <span class="info-label">Prénom</span>
            <span class="info-value"><?= $vendeur->prenom ?></span>
        </div>

        <div class="info-row">
            <span class="info-label">Adresse de contact</span>
            <span class="info-value">
                <a href="mailto:<?=$vendeur->mail?>"><?= $vendeur->mail ?></a>
            </span>
        </div>
    </div>
