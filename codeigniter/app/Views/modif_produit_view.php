...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('public/assets/css/modifProduit.css'); ?>">
...
<div id="content">
    <div id="modif_produit">
        ...
        <form action="<?= base_url('public/ModifProduit/modifProduit/')?>" method="post" enctype="multipart/form-data">
            <div class="details_modif">
                <input type="hidden" name="id" value="<?= $product->id ?>">
                <label for="nom_produit">Nom : </label>
                <input class="text_input" type="text" name="nom" value="<?= session()->get('nom_produit') ?>">
