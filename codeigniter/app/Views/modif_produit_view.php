...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/modifProduit.css'); ?>">
...
<div id="content">
    <div id="modif_produit">
        ...
        <form action="<?= base_url('ModifProduit/modifProduit/')?>" method="post" enctype="multipart/form-data">
