    ...
    <div class="main-box">
        <div class="prod-box">
            <div class="text-box3">
                ...
                <h2 class="petit-txtbox3">768453050</h2>
                <h1 class="petit-txtbox">User :</h1>
                <h2 class="petit-txtbox2">EddieMalou69</h2>
            ...
            <div class="box4">
                <button class="suppr-product2">Annuler commande si état=en cours/Supprimer commande si état=livré</button>
            </div>
        </div>
    </div>
