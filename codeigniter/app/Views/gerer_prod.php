...
<body>
    ...
    <div class="main-box">
        ...
        <div class="prod-box2">
            ...
            <div class="box2">
                <h2 class="question">Changer Nom ?</h2>
                <input type="text" class="reponse" placeholder="nouveau nom">
                <h2 class="question">Changer Desc ?</h2>
                <textarea class="reponse2" name="reponse" rows="3" cols="30" placeholder="Entrez votre texte ici..."></textarea>
            </div>
            <div class="box3">
                <div class="box3-1">
                <h2 class="question3">Changer Prix ? (10000$)</h2>
                <input type="text" class="reponse3" placeholder="nouveau prix">
                </div>
                <h2 class="question6">Stock Actuel:</h2>
                <div class="box3-2">
                <button class="ajout">-</button>
                <input type="text" class="reponse4">
                <button class="ajout">+</button>
                </div>
            </div>
            <div class="box4">
                <?php if (session()->get('role') == 'moderateur') : ?>
                <h2>Vendu par TEST</h2>
                <?php endif;?>
                <button class="apply-changes">Appliquer les modifications</button>
                <button class="suppr-product">Supprimer produit</button>
            </div>
        </div>
    </div>
