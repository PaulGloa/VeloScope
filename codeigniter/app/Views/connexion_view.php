...
<body>
    ...
    <form action="<?php echo base_url('public/Connexion/connexion'); ?>" method="post">
        <div class="connexion-card">
            <a href="<?php echo base_url('public'); ?>"><img src="<?php echo base_url('public/assets/img/logo.jpg'); ?>" class="logo"></a>
            <h1 class="title">Connexion</h1>
            <div>
                <p class="str-type1">Identifiant :</p>
                <input type="text" placeholder="Identifiant" class="info-btn" name="mail" value="<?= $identifiant ?>">
            </div>
            <div>
                <p class="str-type2">Mot de passe :</p>
                <input type="password" placeholder="Mot de passe" class="info-btn" name="password">
            </div>
            ...
            <p class="piti-txt1">Pas encore de compte ? : <a href="<?php echo base_url('public/Inscription'); ?>" class="click-here">Inscription</a></p>
            <p class="piti-txt2">Mot de passe oublié ? : <a href="<?php echo base_url('public/Connexion/forgotPassword'); ?>" class="click-here">Cliquez ici</a></p>
            <input class="seconnecter" type="submit" value="Se Connecter">
        </div>
    </form>
