            ...
            <?php if ($user->role != 'moderateur') : ?>
                <div class="box4">
                    <?php if ( $user->role == 'client') : ?>
                        <a href="<?=base_url('UsersAdmin/toVendeur/' . $user->id)?>"><button class="apply-changes">Changer en Vendeur</button></a>
                    <?php else : ?>
                        <a href="<?=base_url('UsersAdmin/toClient/' . $user->id)?>"><button class="apply-changes">Changer en Client</button></a>
                    <?php endif; ?>
                    <a href="<?=base_url('UsersAdmin/ban/' . $user->id)?>"><button class="suppr-product">Bannir Utilisateur</button></a>
                </div>
            <?php endif;?>
        </div>
        <?php endforeach; ?>
