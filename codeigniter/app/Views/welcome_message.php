...
<header>
	...
	<div class="menu">
		<ul>
			<a href="https://codeigniter.com" target="_blank"><li class="logo"><img height="44" title="CodeIgniter Logo"
			...
			<a href="#"><li class="menu-item hidden">Home</li></a>
			<a href="https://codeigniter4.github.io/userguide/" target="_blank"><li class="menu-item hidden">Docs</li></a>
			<a href="https://forum.codeigniter.com/" target="_blank"><li class="menu-item hidden">Community</li></a>
			<a href="https://github.com/codeigniter4/CodeIgniter4/blob/develop/CONTRIBUTING.md" target="_blank"><li class="menu-item hidden">Contribute</li></a>
		</ul>
	</div>
